...
public class PaymentService {
    ...
    /**
     * 결제 요청을 처리하는 핵심 메서드
     * 파라미터 PaymentRequest -> Payment 로 변경
    ...
    public void processPayment(Payment payment) {
        ...
        // 2. 데이터 완성 (금액 계산, 시간 기록 등)
        // 기존에는 여기서 new Payment()를 했지만, 이제는 넘어온 객체를 완성시킵니다.
        ...
        // 서버 로그 출력
        logger.info("[Service] 결제 승인 완료: 고객명({})", payment.getGuestName());
    }
