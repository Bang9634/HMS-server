...
import com.team3.handler.PaymentHandler; // [추가]
import com.team3.handler.UserHandler;
import com.team3.model.Payment;        // [추가]
import com.team3.model.User;
import com.team3.repository.JsonPaymentRepository; // [추가]
import com.team3.repository.JsonUserRepository;
import com.team3.repository.PaymentRepository;     // [추가]
import com.team3.repository.UserRepository;
import com.team3.server.HmsServer;
import com.team3.service.PaymentService; // [추가]
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HmsServer server = new HmsServer.Builder()
                ...
                // [추가] 결제 핸들러 등록
                .addHandler("/api/payments/process", dependencies.paymentHandler)
                .addHandler("/api/payments/history", dependencies.paymentHandler)
            ...
            System.out.println("Payment API: http://" + host + ":" + port + "/api/payments/process"); // [추가]
            ...
            logger.error("서버 시작 중 알 수 없는 오류 발생", e);
            System.err.println("\n서버 시작 중 알 수 없는 오류 발생");
            System.err.println("오류 메시지: " + e.getMessage());
            System.exit(1);
        }
    }
    ...
    private static class Dependencies {
        ...
        private static final String PAYMENT_DATA_FILE = "data/payments.json"; // [추가]
        ...
        // [추가] Payment 관련 필드
        final JsonFileManager<Payment> paymentJsonFileManager;
        ...
        private Dependencies() {
            ...
            try {
                ...
                this.paymentJsonFileManager = new JsonFileManager<>(
                    PAYMENT_DATA_FILE,
                    new TypeToken<List<Payment>>() {}
                );
                this.paymentRepository = new JsonPaymentRepository(paymentJsonFileManager);
